...
function centralizar(texto: string, largura = 48) {
...
type PedidoCupom = Record<string, unknown> & {
  numero?: string;
  created_date?: string;
  cliente_nome?: string;
  subtotal?: number;
...
export function gerarCupomESCPOS(pedido: PedidoCupom, dadosEmpresa: Record<string, unknown> | null) {
