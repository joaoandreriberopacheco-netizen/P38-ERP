// Port automático de base44/functions/cancelarPedidoVenda/entry.ts
...
async function listarRelacionados(svc: Awaited<ReturnType<typeof createP38Client>>['asServiceRole'], pedidoId: string) {
...
async function cancelarLancamentoComEstorno(
  svc: Awaited<ReturnType<typeof createP38Client>>['asServiceRole'],
  lanc: EntityRecord,
  nota: string,
) {
