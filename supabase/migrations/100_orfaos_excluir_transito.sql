-- =============================================================================
-- 100 — Órfãos v5: excluir trânsito (embarcado − recebido) do saldo órfão
-- =============================================================================
-- Ex.: XNP-7DC / Cocil — 48 discos no embarque 02 a caminho não são órfão.
-- =============================================================================
...
comment on view public.pedido_compra_orfaos_v is
  'Órfãos v5: base M² + saldo_orfa em vitrine. Trânsito (embarcado>recebido) excluído.';
...
comment on view public.pedido_compra_orfaos_resumo_v is
  'Resumo de órfãos por pedido (migration 100).';
