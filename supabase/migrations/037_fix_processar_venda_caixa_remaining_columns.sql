-- 037_fix_processar_venda_caixa_remaining_columns.sql
-- Completa processar_venda_caixa: vale_compra, devolução, turno_caixa.vendas_ids,
-- formas_de_pagamento.nome — colunas promovidas (pós-031/029).
