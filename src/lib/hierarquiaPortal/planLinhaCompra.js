/**
 * Proposta de LINHA + produto_compra + eixos a partir do cadastro legado (h1–h5).
 * Preview only — não altera a base.
 */
...
export const LINHA_ORDEM = ['CIMENTO', 'ARGAMASSA', 'PISO', 'CONEXÃO SOLDÁVEL', 'TINTA'];
