...
export default function CaixasAtivosPage() {
  ...
  return (
    <div className={`flex flex-col h-full min-h-0 bg-background ${caixaTypo.screen}`}>
      <div className="relative flex-1 min-h-0 h-0 overflow-hidden">
      <div className="absolute inset-0 overflow-y-auto overscroll-y-contain touch-pan-y p-4 md:p-6 pb-[var(--p38-scroll-pad-below-nav)] md:pb-6">
