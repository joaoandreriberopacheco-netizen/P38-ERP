...
import { cotacaoExpressHubScrollClass } from './cotacaoExpressLayout';
...
export default function CotacaoExpressHub({
  ...
  return (
    <div className="relative flex h-full min-h-0 flex-1 w-full max-w-full flex-col overflow-hidden">
      <div className={cotacaoExpressHubScrollClass}>
      ...
      <FinanceiroListaEstado
        ...
        vazioIcon={FileText}
      >
        <P38MobileLineList allViewports className="desktop-layout:hidden overflow-visible border-0 rounded-none bg-transparent shadow-none">
