  ...
  return (
    <div className="space-y-3">
      {embarques.map((embarque, idx) => {
        ...
        const playButton = statusRecebimento === 'Pendente' ? (
          <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-blue-600 dark:bg-blue-500 flex items-center justify-center shadow-md hover:shadow-lg transition-shadow flex-shrink-0">
            <Play className="w-5 h-5 text-white fill-white" />
          </div>
        ) : (
          <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-muted flex items-center justify-center hover:bg-muted dark:hover:bg-muted transition-colors flex-shrink-0">
        ...
        return (
          <button
            ...
            className="w-full text-left bg-muted/50 hover:bg-muted rounded-2xl p-4 sm:p-5 transition-all duration-200 shadow-sm hover:shadow-md"
          >
            <div className="flex flex-col gap-3">
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-2 min-w-0 flex-1">
                  ...
                  <div className="flex-shrink-0">{getStatusIcon(statusRecebimento)}</div>
                </div>
                {playButton}
              </div>
              ...
              <span className={`inline-flex self-start px-3 py-1.5 text-xs font-semibold rounded-full ${
                statusRecebimento === 'Pendente'
