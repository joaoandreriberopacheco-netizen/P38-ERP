  ...
  return (
    <div
      className={cn(
        ...
        muted && 'bg-muted/60 dark:bg-[#26262e]/80 opacity-60',
      )}
    >
  ...
  return (
    <div
      className={cn(
        ...
        disabled
          ? 'bg-muted/60 dark:bg-[#26262e]/80 opacity-60'
          : 'bg-muted/40 dark:bg-[#26262e] cursor-pointer hover:bg-muted dark:hover:bg-[#383e47]',
      )}
      onClick={() => {
        if (disabled) return;
