...
export const P38_SEARCH = 'bg-card border-0 shadow-sm h-11 rounded-lg focus-visible:ring-2 focus-visible:ring-[#f07a1a]/18 dark:p38-search-field dark:shadow-none dark:focus-visible:ring-1 dark:focus-visible:ring-border/60';
...
export const P38_ACCENT = 'text-[#f07a1a] dark:text-[#a4ce33]';
